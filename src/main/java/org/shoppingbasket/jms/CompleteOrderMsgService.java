...
public class CompleteOrderMsgService {

    @Inject
    @Logging
    Logger logger;

    @Inject @JMSConnectionFactory("jms/ShoppingBasket/completeOrdQueue")
    JMSContext context;

    @Resource(mappedName = "jms/completeOrdQueue")
    Queue queue;

    public void submitOrder(String orderId) {
        logger.log(Level.INFO, "Completing the Order:".concat(orderId));

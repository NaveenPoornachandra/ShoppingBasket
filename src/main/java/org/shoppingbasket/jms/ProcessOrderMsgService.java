...
public class ProcessOrderMsgService {

    @Inject
    @Logging
    Logger logger;

    @Inject @JMSConnectionFactory("jms/ShoppingBasket/processOrderQueue")
    JMSContext context;

    @Resource(mappedName = "jms/processOrderQueue")
    Queue queue;

    public void submitOrder(String orderId) {
        logger.log(Level.INFO, "Pocessing the Order:".concat(orderId));

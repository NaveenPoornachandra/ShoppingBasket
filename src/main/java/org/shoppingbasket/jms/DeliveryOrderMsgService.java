...
public class DeliveryOrderMsgService {

    @Inject
    @Logging
    Logger logger;

    @Inject @JMSConnectionFactory("jms/ShoppingBasket/deliveryOrderQueue")
    JMSContext context;

    @Resource(mappedName = "jms/deliveryOrderQueue")
    Queue queue;

    public void submitOrder(String orderId) {
        logger.log(Level.INFO, "Delivering the Order:".concat(orderId));

...
public class CompleteOrderScheduler {
    ...
    @Schedule(hour="*", minute="*/1", second="40", info = "Every 4 second timer")
    public void process(){
        logger.log(Level.INFO,"Complete Order Scheduler Scheduler started......");
        ...
        logger.log(Level.INFO,"Complete Order Scheduler Completed @ ".concat(new Date().toString()));
